<template>
  ...
  PNG, JPG (MAX. 800x800px)
        ...
        <div class="space-y-2">
          ...
          <Select v-model="form.nationality">
            <SelectTrigger class="w-full rounded-xl border px-4 py-3 bg-form-field border-border text-primary">
  ...
  const emit = defineEmits<{
    (e: 'submit', data: { name: string; nationality: string; biography: string; image?: File }): void
  }>();
